...
namespace PolyAndCode.UI
{
    ...
    public class VerticalRecyclingSystem : RecyclingSystem
    {
        ...
        #region INIT
        public VerticalRecyclingSystem(RectTransform prototypeCell, RectTransform viewport, RectTransform content, IRecyclableScrollRectDataSource dataSource, bool isGrid, int columns)
        {
        ...
        private void CreateCellPool()
        {
            ...
            if (IsGrid)
            {
                _bottomMostCellColoumn = (_bottomMostCellColoumn - 1 + _columns) % _columns;
            }
